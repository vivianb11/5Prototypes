...
public class GlobalControler : MonoBehaviour
{
    public PlayerStats globalStats;

    public float moveSpeed = 5f;    // Player movement speed
    public float rotationSpeed = 250f;  // Player rotation speed
    ...
    private void Awake()
    {
        if (globalStats == null)
        {
            globalStats = this.GetComponent<PlayerStats>();
        }
    }
